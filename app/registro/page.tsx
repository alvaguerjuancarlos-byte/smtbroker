...
export default function RegistroPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA]">
      ...
      {/* Header público */}
      <header className="bg-white border-b border-[#DDE3EC] px-6 py-4 flex items-center gap-3">
      ...
      <main className="px-6 py-12">
        <div className="w-full max-w-[760px] mx-auto flex flex-col gap-10">
          ...
          <div className="text-center">
            ...
            <h1 className="text-[32px] font-black text-[#111827] leading-tight">
              Únete al ecosistema<br />SMTBROKER
            </h1>
            <p className="text-[15px] text-[#8EA0BC] mt-3 max-w-[480px] mx-auto leading-relaxed">
          ...
          {rol && rolActivo && (
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-[#DDE3EC] p-8 flex flex-col gap-6">
              <div>
                ...
                <h2 className="text-[20px] font-black text-[#111827]">Completa tu registro</h2>
